...
var icons = {
    fail: React.createElement(SvgClose, { fill: "#fff" }),
    loading: React.createElement(SvgLoading, { fill: "#fff", className: styles.loading }),
    success: React.createElement(SvgCheck, { fill: "#fff" }),
};
function Icon(_a) {
    var type = _a.type;
    return icons[type];
...
eventManager.subscribe('popmessage', function () {
    ...
    ReactDOM.render(React.createElement(Toast, { type: type, content: content, duration: duration, onClose: function () {
